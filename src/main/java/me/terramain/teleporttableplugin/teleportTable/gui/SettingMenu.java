...
public class SettingMenu implements GUIFunctions {

    public static GUI getMenu(Location tableLocation){
        return new GUI(
                new SettingMenu(tableLocation),
                GUIType.HOPPER
        );
    }

    Location tableLocation;
    public SettingMenu(Location tableLocation){
