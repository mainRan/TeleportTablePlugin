package me.terramain.teleporttableplugin.teleportTable.gui;
...
public class MainMenu implements GUIFunctions {

    public static GUI getMenu(TeleportTable table){
        return new GUI(
                new MainMenu(table),
                GUIType.CHEST
        );
    ...
    public TeleportTable table;
    public MainMenu(TeleportTable table){
        this.table=table;
    }
    ...
    public void onCreate(GUI gui) {
        ...
        gui.setItem(13, new GenItem(Material.ENDER_EYE).setName(ChatColor.RED +""+ ChatColor.BOLD + "ваш алтарь").compile());//центральный глаз
